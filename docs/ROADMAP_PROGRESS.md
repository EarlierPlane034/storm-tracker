...
| 69 | Freezing level height — data was already fetched and used in scoring, just never shown; added to the AI environment discussion | `js/ui/aiPanel.js` (`buildEnvDiscussion`) |
